...
class SubscribersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscriber" do
    assert_difference("Subscriber.count") do
      post subscribers_url, params: { subscriber: { email: @subscriber.email, location: @subscriber.location, unsubscribed_at: @subscriber.unsubscribed_at } }
    end
  ...
  test "should update subscriber" do
    patch subscriber_url(@subscriber), params: { subscriber: { email: @subscriber.email, location: @subscriber.location, unsubscribed_at: @subscriber.unsubscribed_at } }
